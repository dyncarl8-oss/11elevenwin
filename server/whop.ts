...
const whopAppId = process.env.WHOP_APP_ID || process.env.NEXT_PUBLIC_WHOP_APP_ID;

if (!whopAppId) {
  console.warn("WHOP_APP_ID or NEXT_PUBLIC_WHOP_APP_ID not found. Whop authentication will not work.");
}
